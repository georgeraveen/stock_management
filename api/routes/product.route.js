...
//edit product name
productRoutes.route('/editName/:id/:newName/:newStockMaintain').post(function (req, res) {
    Product.findOneAndUpdate(
        { "_id": req.params.id },
        { $set: { "productName": req.params.newName, "stockMaintain": req.params.newStockMaintain } },
        function (err, p) {
            console.log('hi');
            if (err) {
                return res.send(err);
